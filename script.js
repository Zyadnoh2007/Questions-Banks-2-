...
document.addEventListener("DOMContentLoaded", () => {
    // 1. التحقق من الاسم عند فتح الموقع
    ...
    // 4. إعداد واجهة البداية
    hideAllViews();
    document.getElementById('main-nav').style.display = 'flex';
    selectSubject('microbiology');
});

// --- دوال الدخول (إصلاح المشكلة) ---
// جعلنا الدوال Global (معلقة بالـ window) عشان الـ HTML يشوفها
